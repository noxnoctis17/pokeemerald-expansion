...
#define FLAG_COMPLETED_WALLY_TUTORIAL                               0x46D // Unused Flag, leftover from R/S. HM08 is given to the player directly in Emerald
#define FLAG_ITEM_ROUTE_119_NUGGET                                  0x46E
#define FLAG_ITEM_ROUTE_104_POTION                                  0x46F
#define FLAG_REACHED_LEVEL_10                                       0x470 // Unused Flag
...
#define FLAG_ITEM_SKYPILLAR4F_TM_DAZZLING_GLEAM                     0x493 // Unused Flag
...
#define FLAG_REMATCHED_ROXANNE                      (SYSTEM_FLAGS + 0x21) // Unused Flag FLAG_UNUSED_0x881
#define FLAG_REMATCHED_BRAWLY                       (SYSTEM_FLAGS + 0x22) // Unused Flag FLAG_UNUSED_0x882
#define FLAG_REMATCHED_WATTSON                      (SYSTEM_FLAGS + 0x23) // Unused Flag FLAG_UNUSED_0x883
#define FLAG_REMATCHED_FLANNERY                     (SYSTEM_FLAGS + 0x24) // Unused Flag FLAG_UNUSED_0x884
#define FLAG_REMATCHED_NORMAN                       (SYSTEM_FLAGS + 0x25) // Unused Flag FLAG_UNUSED_0x885
#define FLAG_REMATCHED_WINONA                       (SYSTEM_FLAGS + 0x26) // Unused Flag FLAG_UNUSED_0x886
#define FLAG_REMATCHED_TATELIZA                     (SYSTEM_FLAGS + 0x27) // Unused Flag FLAG_UNUSED_0x887
...
#define FLAG_REMATCHED_JUAN                         (SYSTEM_FLAGS + 0x2E) // Unused Flag FLAG_UNUSED_0x88E
#define FLAG_REMATCHED_ALL_GYMS                     (SYSTEM_FLAGS + 0x2F) // Unused Flag FLAG_UNUSED_0x88F
