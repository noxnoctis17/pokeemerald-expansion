...
const u16 gEasyChatWordsByLetter_M[] = {
    EC_MOVE2(MACH_PUNCH),
    DOUBLE_SPECIES_NAME
    // EC_POKEMON_NATIONAL( MEOMBER ),
    // EC_POKEMON_NATIONAL( MEORMOR ),
...
const u16 gEasyChatWordsByLetter_N[] = {
    ...
    EC_WORD_NAP,
    DOUBLE_SPECIES_NAME
    // EC_POKEMON_NATIONAL( NURDIBRAG ),
    // EC_POKEMON_NATIONAL( NURDIBRAGON ),
