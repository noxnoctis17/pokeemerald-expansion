...
#define GALLADE_MISC_INFO                                   \
    ...
    [SPECIES_DELCATTY] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_PIXILATE, ABILITY_NORMALIZE, ABILITY_WONDER_SKIN }, //--NOX SWAP cute charm TO PIXILATE
        .bodyColor = BODY_COLOR_PURPLE,
...
#define ALTARIA_MISC_INFO                                              \
    ...
    [SPECIES_ALTARIA] =
    {
        ...
        .abilities = { ABILITY_PIXILATE, ABILITY_LEVITATE, ABILITY_CLOUD_NINE },
        .cryId = CRY_ALTARIA,
        .height = 11,
        .weight = 206,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_ARMALDO] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_SAND_RUSH, ABILITY_SWIFT_SWIM }, //--nox armaldo buff 2nd empty ability -> Sand Rush
        .bodyColor = BODY_COLOR_GRAY,
...
#define BANETTE_MISC_INFO                                           \
    ...
    [SPECIES_CHIMECHO] =
    {
        ...
        .baseSpAttack  = 95,
            ...
            .baseSpDefense = 80,
        #endif
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_NORMAL), //--nox buff chimecho, secondary typing -> normal
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 159,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_PSYCHIC_SURGE }, //--nox buff chimecho second ability none -> psychic surge to become indeedee at home
        .bodyColor = BODY_COLOR_BLUE,
