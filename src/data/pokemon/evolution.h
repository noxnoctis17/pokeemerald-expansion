const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    //==[Nox Mons]==
    [SPECIES_SNASEE] = {{ EVO_LEVEL, 16, SPECIES_REBELINUM }},
    [SPECIES_REBELINUM] = {{ EVO_LEVEL, 34, SPECIES_KNIGHINUM }},
    [SPECIES_MEOUCHIE] = {{ EVO_LEVEL, 16, SPECIES_MEOMBER }},
    [SPECIES_MEOMBER] = {{ EVO_LEVEL, 36, SPECIES_MEORMOR }},
    [SPECIES_NURDIBRANCH] = {{ EVO_LEVEL, 16, SPECIES_NURDIBRAG }},
    [SPECIES_NURDIBRAG] = {{ EVO_LEVEL, 38, SPECIES_NURDIBRAGON }},
};
