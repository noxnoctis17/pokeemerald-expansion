const struct Trainer gTrainers[] = {
    ...
    [TRAINER_SIDNEY] =
    {
        ...
        .aiFlags = AI_FLAG_DOUBLE_BATTLE | AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_SETUP_FIRST_TURN,
    ...
    [TRAINER_JUAN_1] =
    {
        ...
        .startingStatus = B_WEATHER_RAIN_TEMPORARY,
    },
