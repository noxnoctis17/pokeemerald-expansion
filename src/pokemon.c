...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    //==[Nox Mons]==
    SPECIES_TO_NATIONAL( SNASEE ),
    SPECIES_TO_NATIONAL( REBELINUM ),
    SPECIES_TO_NATIONAL( KNIGHINUM ),
    SPECIES_TO_NATIONAL( MEOUCHIE ),
    SPECIES_TO_NATIONAL( MEOMBER ),
    SPECIES_TO_NATIONAL( MEORMOR ),
    SPECIES_TO_NATIONAL( NURDIBRANCH ),
    SPECIES_TO_NATIONAL( NURDIBRAG ),
    SPECIES_TO_NATIONAL( NURDIBRAGON ),
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    //==[Nox Mons]==
    [SPECIES_SNASEE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_REBELINUM - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_KNIGHINUM - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MEOUCHIE - 1] = ANIM_H_SHAKE_FAST,
    [SPECIES_MEOMBER - 1] = ANIM_H_SHAKE_FAST,
    [SPECIES_MEORMOR- 1] = ANIM_H_SHAKE_FAST,
    [SPECIES_NURDIBRANCH - 1] = ANIM_GROW_VIBRATE,
    [SPECIES_NURDIBRAG - 1] = ANIM_GROW_VIBRATE,
    [SPECIES_NURDIBRAGON - 1] = ANIM_GROW_VIBRATE,
